...
def floor_div(args):
    ...
    evaluated_args = args.map(calc_eval)
    result = evaluated_args.first
    while evaluated_args.rest is not nil:
        evaluated_args = evaluated_args.rest 
        result = result // evaluated_args.first 
